...
package com.chartiq.chartiqsample.ui;
...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
            ...
            for (int i = 1; i < count; i++) {
                ...
                if (adapterPosHere != RecyclerView.NO_POSITION) {
                    ...
                    if (nextId != currentId) {
                        ...
                        final int offset = ((int) next.getY()) - (headerHeight + getItemHeight(parent, adapterPosHere));
                        if (offset < 0) {
                            return offset;
                        } else {
                            break;
    ...
    private int getItemHeight(RecyclerView parent, int adapterPosHere){
        View view = getHeader(parent, adapterPosHere).itemView;
        return (view.getVisibility() == View.GONE ? 0 : view.getHeight());
    }
}
